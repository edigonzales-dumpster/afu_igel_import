CREATE SCHEMA IF NOT EXISTS afu_igel;
CREATE SEQUENCE afu_igel.t_ili2db_seq;;
-- SO_AFU_Igel_202000429.Igel.Stall
CREATE TABLE afu_igel.igel_stall (
  T_Id bigint PRIMARY KEY DEFAULT nextval('afu_igel.t_ili2db_seq')
  ,T_Ili_Tid uuid NULL DEFAULT uuid_generate_v4()
  ,content text NOT NULL
)
;
COMMENT ON TABLE afu_igel.igel_stall IS 'Ställe aus IGEL-Applikation';
COMMENT ON COLUMN afu_igel.igel_stall.content IS 'Inhalt eines JSON-Objektes des heruntergeladenen Datensatzs.';
-- SO_AFU_Igel_202000429.Igel.Standort
CREATE TABLE afu_igel.igel_standort (
  T_Id bigint PRIMARY KEY DEFAULT nextval('afu_igel.t_ili2db_seq')
  ,T_Ili_Tid uuid NULL DEFAULT uuid_generate_v4()
  ,content text NOT NULL
)
;
COMMENT ON TABLE afu_igel.igel_standort IS 'Standorte aus IGEL-Applikation';
COMMENT ON COLUMN afu_igel.igel_standort.content IS 'Inhalt eines JSON-Objektes des heruntergeladenen Datensatzs.';
CREATE TABLE afu_igel.T_ILI2DB_BASKET (
...
;
CREATE INDEX T_ILI2DB_BASKET_dataset_idx ON afu_igel.t_ili2db_basket ( dataset );
CREATE TABLE afu_igel.T_ILI2DB_DATASET (
  T_Id bigint PRIMARY KEY
  ,datasetName varchar(200) NULL
)
;
CREATE TABLE afu_igel.T_ILI2DB_INHERITANCE (
  thisClass varchar(1024) PRIMARY KEY
  ,baseClass varchar(1024) NULL
)
;
CREATE TABLE afu_igel.T_ILI2DB_SETTINGS (
  tag varchar(60) PRIMARY KEY
  ,setting varchar(1024) NULL
)
;
CREATE TABLE afu_igel.T_ILI2DB_TRAFO (
  iliname varchar(1024) NOT NULL
  ,tag varchar(1024) NOT NULL
  ,setting varchar(1024) NOT NULL
)
;
CREATE TABLE afu_igel.T_ILI2DB_MODEL (
...
;
CREATE TABLE afu_igel.T_ILI2DB_CLASSNAME (
  IliName varchar(1024) PRIMARY KEY
  ,SqlName varchar(1024) NOT NULL
)
;
CREATE TABLE afu_igel.T_ILI2DB_ATTRNAME (
  IliName varchar(1024) NOT NULL
  ,SqlName varchar(1024) NOT NULL
...
;
CREATE TABLE afu_igel.T_ILI2DB_COLUMN_PROP (
...
;
CREATE TABLE afu_igel.T_ILI2DB_TABLE_PROP (
  tablename varchar(255) NOT NULL
  ,tag varchar(1024) NOT NULL
  ,setting varchar(1024) NOT NULL
)
;
CREATE TABLE afu_igel.T_ILI2DB_META_ATTRS (
  ilielement varchar(255) NOT NULL
  ,attr_name varchar(1024) NOT NULL
  ,attr_value varchar(1024) NOT NULL
)
;
ALTER TABLE afu_igel.T_ILI2DB_BASKET ADD CONSTRAINT T_ILI2DB_BASKET_dataset_fkey FOREIGN KEY ( dataset ) REFERENCES afu_igel.T_ILI2DB_DATASET DEFERRABLE INITIALLY DEFERRED;
CREATE UNIQUE INDEX T_ILI2DB_DATASET_datasetName_key ON afu_igel.T_ILI2DB_DATASET (datasetName)
;
CREATE UNIQUE INDEX T_ILI2DB_MODEL_iliversion_modelName_key ON afu_igel.T_ILI2DB_MODEL (iliversion,modelName)
;
CREATE UNIQUE INDEX T_ILI2DB_ATTRNAME_ColOwner_SqlName_key ON afu_igel.T_ILI2DB_ATTRNAME (ColOwner,SqlName)
;
INSERT INTO afu_igel.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('SO_AFU_Igel_202000429.Igel.Stall','igel_stall');
INSERT INTO afu_igel.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('SO_AFU_Igel_202000429.Igel.Standort','igel_standort');
INSERT INTO afu_igel.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('SO_AFU_Igel_202000429.Igel.Stall.Content','content','igel_stall',NULL);
INSERT INTO afu_igel.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('SO_AFU_Igel_202000429.Igel.Standort.Content','content','igel_standort',NULL);
INSERT INTO afu_igel.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('SO_AFU_Igel_202000429.Igel.Stall','ch.ehi.ili2db.inheritance','newClass');
INSERT INTO afu_igel.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('SO_AFU_Igel_202000429.Igel.Standort','ch.ehi.ili2db.inheritance','newClass');
INSERT INTO afu_igel.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('SO_AFU_Igel_202000429.Igel.Stall',NULL);
INSERT INTO afu_igel.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('SO_AFU_Igel_202000429.Igel.Standort',NULL);
INSERT INTO afu_igel.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('igel_standort',NULL,'content','ch.ehi.ili2db.textKind','MTEXT');
INSERT INTO afu_igel.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('igel_stall',NULL,'content','ch.ehi.ili2db.textKind','MTEXT');
INSERT INTO afu_igel.T_ILI2DB_TABLE_PROP (tablename,tag,setting) VALUES ('igel_stall','ch.ehi.ili2db.tableKind','CLASS');
INSERT INTO afu_igel.T_ILI2DB_TABLE_PROP (tablename,tag,setting) VALUES ('igel_standort','ch.ehi.ili2db.tableKind','CLASS');
INSERT INTO afu_igel.T_ILI2DB_MODEL (filename,iliversion,modelName,content,importDate) VALUES ('CHBase_Part4_ADMINISTRATIVEUNITS_20110830.ili','2.3','CHAdminCodes_V1 AdministrativeUnits_V1{ CHAdminCodes_V1 InternationalCodes_V1 Dictionaries_V1 Localisation_V1 INTERLIS} AdministrativeUnitsCH_V1{ CHAdminCodes_V1 InternationalCodes_V1 LocalisationCH_V1 AdministrativeUnits_V1 INTERLIS}','/* ########################################################################
...
!! ########################################################################
','2020-04-29 14:09:26.658');
INSERT INTO afu_igel.T_ILI2DB_MODEL (filename,iliversion,modelName,content,importDate) VALUES ('Units-20120220.ili','2.3','Units','!! File Units.ili Release 2012-02-20
...
','2020-04-29 14:09:26.658');
INSERT INTO afu_igel.T_ILI2DB_MODEL (filename,iliversion,modelName,content,importDate) VALUES ('CoordSys-20151124.ili','2.3','CoordSys','!! File CoordSys.ili Release 2015-11-24
...
','2020-04-29 14:09:26.658');
INSERT INTO afu_igel.T_ILI2DB_MODEL (filename,iliversion,modelName,content,importDate) VALUES ('CHBase_Part2_LOCALISATION_20110830.ili','2.3','InternationalCodes_V1 Localisation_V1{ InternationalCodes_V1} LocalisationCH_V1{ InternationalCodes_V1 Localisation_V1} Dictionaries_V1{ InternationalCodes_V1} DictionariesCH_V1{ InternationalCodes_V1 Dictionaries_V1}','/* ########################################################################
   CHBASE - BASE MODULES OF THE SWISS FEDERATION FOR MINIMAL GEODATA MODELS
   ======
   BASISMODULE DES BUNDES           MODULES DE BASE DE LA CONFEDERATION
   FÜR MINIMALE GEODATENMODELLE     POUR LES MODELES DE GEODONNEES MINIMAUX
...
!! ########################################################################
','2020-04-29 14:09:26.658');
INSERT INTO afu_igel.T_ILI2DB_MODEL (filename,iliversion,modelName,content,importDate) VALUES ('CHBase_Part1_GEOMETRY_20110830.ili','2.3','GeometryCHLV03_V1{ CoordSys Units INTERLIS} GeometryCHLV95_V1{ CoordSys Units INTERLIS}','/* ########################################################################
   CHBASE - BASE MODULES OF THE SWISS FEDERATION FOR MINIMAL GEODATA MODELS
   ======
   BASISMODULE DES BUNDES           MODULES DE BASE DE LA CONFEDERATION
   FÜR MINIMALE GEODATENMODELLE     POUR LES MODELES DE GEODONNEES MINIMAUX
...
!! ########################################################################
','2020-04-29 14:09:26.658');
INSERT INTO afu_igel.T_ILI2DB_MODEL (filename,iliversion,modelName,content,importDate) VALUES ('SO_AFU_Igel_20200429.ili','2.3','SO_AFU_Igel_202000429{ GeometryCHLV95_V1 CHAdminCodes_V1}','INTERLIS 2.3;
...
','2020-04-29 14:09:26.658');
INSERT INTO afu_igel.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.createMetaInfo','True');
INSERT INTO afu_igel.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.beautifyEnumDispName','underscore');
INSERT INTO afu_igel.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.interlis.ili2c.ilidirs','http://models.geo.admin.ch;model/');
INSERT INTO afu_igel.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.arrayTrafo','coalesce');
INSERT INTO afu_igel.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.createForeignKeyIndex','yes');
INSERT INTO afu_igel.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.nameOptimization','topic');
INSERT INTO afu_igel.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.localisedTrafo','expand');
INSERT INTO afu_igel.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.jsonTrafo','coalesce');
INSERT INTO afu_igel.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.numericCheckConstraints','create');
INSERT INTO afu_igel.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.sender','ili2pg-4.3.1-23b1f79e8ad644414773bb9bd1a97c8c265c5082');
INSERT INTO afu_igel.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.createForeignKey','yes');
INSERT INTO afu_igel.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.sqlgen.createGeomIndex','True');
INSERT INTO afu_igel.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.defaultSrsAuthority','EPSG');
INSERT INTO afu_igel.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.defaultSrsCode','2056');
INSERT INTO afu_igel.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.createEnumDefs','multiTable');
INSERT INTO afu_igel.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.maxSqlNameLength','60');
INSERT INTO afu_igel.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.uuidDefaultValue','uuid_generate_v4()');
INSERT INTO afu_igel.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.inheritanceTrafo','smart1');
INSERT INTO afu_igel.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.catalogueRefTrafo','coalesce');
INSERT INTO afu_igel.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.multiPointTrafo','coalesce');
INSERT INTO afu_igel.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.StrokeArcs','enable');
INSERT INTO afu_igel.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.multiLineTrafo','coalesce');
INSERT INTO afu_igel.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.multiSurfaceTrafo','coalesce');
INSERT INTO afu_igel.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.multilingualTrafo','expand');
INSERT INTO afu_igel.T_ILI2DB_META_ATTRS (ilielement,attr_name,attr_value) VALUES ('DictionariesCH_V1','furtherInformation','http://www.geo.admin.ch/internet/geoportal/de/home/topics/geobasedata/models.html');
INSERT INTO afu_igel.T_ILI2DB_META_ATTRS (ilielement,attr_name,attr_value) VALUES ('DictionariesCH_V1','technicalContact','models@geo.admin.ch');
INSERT INTO afu_igel.T_ILI2DB_META_ATTRS (ilielement,attr_name,attr_value) VALUES ('Dictionaries_V1','furtherInformation','http://www.geo.admin.ch/internet/geoportal/de/home/topics/geobasedata/models.html');
INSERT INTO afu_igel.T_ILI2DB_META_ATTRS (ilielement,attr_name,attr_value) VALUES ('Dictionaries_V1','technicalContact','models@geo.admin.ch');
INSERT INTO afu_igel.T_ILI2DB_META_ATTRS (ilielement,attr_name,attr_value) VALUES ('AdministrativeUnits_V1','furtherInformation','http://www.geo.admin.ch/internet/geoportal/de/home/topics/geobasedata/models.html');
INSERT INTO afu_igel.T_ILI2DB_META_ATTRS (ilielement,attr_name,attr_value) VALUES ('AdministrativeUnits_V1','technicalContact','models@geo.admin.ch');
INSERT INTO afu_igel.T_ILI2DB_META_ATTRS (ilielement,attr_name,attr_value) VALUES ('AdministrativeUnitsCH_V1','furtherInformation','https://www.geo.admin.ch/de/geoinformation-schweiz/geobasisdaten/geodata-models.html');
INSERT INTO afu_igel.T_ILI2DB_META_ATTRS (ilielement,attr_name,attr_value) VALUES ('AdministrativeUnitsCH_V1','technicalContact','mailto:models@geo.admin.ch');
